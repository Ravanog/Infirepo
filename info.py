...
# Bot information
API_ID = environ.get('API_ID', '2416')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '5OLDV5BSiLw')
if len(BOT_TOKEN) == 0:
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodbe&w=majority")
